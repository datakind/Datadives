...
\date{\today}
\institution{\includegraphics[width = 3cm]{Benetech-Logo-tag.jpg}}
...
<<TotalUsagePlot, fig=TRUE, echo=FALSE>>=
...
<<AverageDailyUsagePlot, fig=TRUE, echo=FALSE>>=
...
<<AverageDailyUsagePlotTruncated, fig=TRUE, echo=FALSE>>=
